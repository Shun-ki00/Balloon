// ============================================
// 
// ファイル名: ResultTextUI.h
// 概要: ResultTextUI.cppのヘッダーファイル
// 
// 製作者 : 清水駿希
// 
// ============================================
...
public:
	...
	// テキストID
	enum class TextID : unsigned int
	{
		CLEAR = 0,
		FAILED,
	};
...
public:
	...
	// コンストラクタ
	ResultTextUI(IObject* root, IObject* parent, IObject::ObjectID objectID,
