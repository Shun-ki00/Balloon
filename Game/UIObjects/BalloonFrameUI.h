// ============================================
// 
// ファイル名: BalloonFrameUI.h
// 概要: BalloonFrameUI.cppのヘッダーファイル
// 
// 製作者 : 清水駿希
// 
// ============================================
...
class BalloonFrameUI : public UIObject, public IComposite
{
public:
	// オブジェクトのアクティブ設定
...
public:
	...
	// コンストラクタ
	BalloonFrameUI(IObject* parent, IObject::ObjectID objectID,
		const DirectX::SimpleMath::Vector3& position,
		const DirectX::SimpleMath::Quaternion& rotation,
		const DirectX::SimpleMath::Vector3& scale);

	// デストラクタ
	~BalloonFrameUI() override = default;
