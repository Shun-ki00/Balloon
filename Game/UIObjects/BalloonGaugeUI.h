// ============================================
// 
// ファイル名: BalloonGaugeUI.h
// 概要: BalloonGaugeUI.cppのヘッダーファイル
// 
// 製作者 : 清水駿希
// 
// ============================================
...
class BalloonGaugeUI : public UIObject, public IComposite
{
public:
	// オブジェクトのアクティブ設定
...
public:
	...
	// コンストラクタ
	BalloonGaugeUI(IObject* parent, IObject::ObjectID objectID,
		const DirectX::SimpleMath::Vector3& position,
		const DirectX::SimpleMath::Quaternion& rotation,
		const DirectX::SimpleMath::Vector3& scale);

	// デストラクタ
	~BalloonGaugeUI() override = default;
