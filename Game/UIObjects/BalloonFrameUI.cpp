...
BalloonFrameUI::BalloonFrameUI(IObject* parent, IObject::ObjectID objectID,
...
/// 初期化処理
/// </summary>
void BalloonFrameUI::Initialize()
{
	// テクスチャサイズを取得する
	float width, height;
	Resources::GetInstance()->GetTextureResources()->GetTextureSize(TextureKeyID::BalloonGageFrame, width, height);
	...
	// 初期化
	m_renderableObject->Initialize(vertexBuffer, TextureKeyID::BalloonGageFrame, TextureKeyID::Rule ,PS_ID::UI_PS);
...
void BalloonFrameUI::Attach(std::unique_ptr<IObject> object)
{
...
void BalloonFrameUI::Detach(std::unique_ptr<IObject> object)
{
...
void BalloonFrameUI::OnMessegeAccepted(Message::MessageData messageData)
{
...
void BalloonFrameUI::OnKeyPressed(KeyType type, const DirectX::Keyboard::Keys& key)
{
